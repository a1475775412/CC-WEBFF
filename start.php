<?php 
	...
	if(isset($_SESSION['standby'])){
		...
		<div class="loading" style="margin-top: 11%;">
		  ...
		  <div class="loading__msg"><center><b style="font-size: 22px;"><a href="https://jq.qq.com/?_wv=1027&k=5o5VCed" target="_blank" style="color: black;">ANTIDDOS</a> is checking....</b><br><br>Hi, dont worry, this is a simple security verfication, you will see this only one time;<br> your webpage will show up soon</center></div>
		</div>
